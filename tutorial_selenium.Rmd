...
library(netstat)
```
Source: https://www.youtube.com/watch?v=U1BrIPmhx10
...
# finding elements
electronics_object <- remDr$findElement(using = 'link text', 'Tecnología')
...
us_checkbox <- remDr$findElement(using = 'xpath', '//input[@aria-label="Estados Unidos"]')
...
remDr$findElement(using = 'xpath', '//input[@aria-label="Blanco"]')$clickElement()
...
system("kill $(ps aux | grep 'java' | awk '{print $2}')")
